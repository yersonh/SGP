        ...
        <div class="result-card" id="resultCard">
            ...
            <div class="download-section">
                <div class="download-header">
                    ...
                    <span class="download-count" id="registrosHoy">0 registros hoy</span>
                </div>
            ...
            <div class="recent-activity">
                <div class="recent-title">
                    ...
                    <h5>Últimos votantes registrados</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    actualizarStats();
                    document.getElementById('registrosHoy').textContent = data.stats.votaron_hoy + ' registros hoy';
                    ...
                    const nombre = document.getElementById('personaNombre').textContent;
                    const cedula = document.getElementById('personaCedula').textContent;
                    ...
                    recentItem.innerHTML = `
                        <div class="recent-info">
                            <i class="fas fa-check-circle"></i>
                            <span>${cedula} - ${nombre}</span>
                        </div>
                        <div class="recent-time">Hace unos segundos</div>
                    `;
