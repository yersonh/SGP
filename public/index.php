...
// 4. Obtener todos los usuarios para la tabla - AHORA CON fecha_creacion
...
<head>
    ...
    <style>
        ...
        /* Status Badges - CORREGIDO para PostgreSQL boolean */
        .badge-status {
            padding: 6px 12px;
            border-radius: 20px;
            font-size: 0.85rem;
                        ...
                        <table class="table table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        // CORRECCIÓN IMPORTANTE: Para PostgreSQL boolean
                                        $activo = $usuario['activo'];
                                        // En PostgreSQL, boolean puede venir como: true, false, 't', 'f', 1, 0
