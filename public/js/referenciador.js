...
console.log('=== INICIANDO SISTEMA DE RATING ===');
console.log('Estrellas encontradas:', stars.length);
console.log('Input afinidad:', afinidadInput);
console.log('Valor rating:', ratingValue);

// Verificar que FontAwesome esté cargado
if (!document.querySelector('.fa-star')) {
    console.warn('⚠️ FontAwesome no parece estar cargado');
}
...
if (document.getElementById('referenciacion-form')) {
...
function updateInsumosDisplay() {
    if (!insumosSelectedDiv) {
        console.log('insumosSelectedDiv no está definido');
        return;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('puesto_votacion')) {
        document.getElementById('puesto_votacion').disabled = true;
        document.getElementById('puesto_votacion').innerHTML = '<option value="">Primero seleccione un sector</option>';
    }
...
document.addEventListener('click', function(e) {
    // Si es una estrella, no hacer nada
