...
<head>
    ...
    <title>Panel Auditoría - SGP</title>
        ...
        <div class="header-container">
            <div class="header-top">
                <div class="header-title">
                    <h1><i class="fas fa-clipboard-check"></i> Panel de Auditoría</h1>
                    <div class="user-info">
    ...
    <div class="main-container">
        ...
        <div class="dashboard-header">
            ...
            <p class="dashboard-subtitle">
                Módulo de control, trazabilidad y verificación de operaciones del sistema.
                Supervise actividades, accesos y el aporte de líderes en el proceso de referidos.
            </p>
        </div>
